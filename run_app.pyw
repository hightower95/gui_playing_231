...
def main():
    ...
    try:
        ...
        current_version = get_installed_version(venv_python, "requests")
        ...
        if current_version:
            ...
            target_version = should_upgrade(current_version, config, venv_python, "requests")
            ...
            if target_version:
                ...
                upgrade_success = upgrade_to_version(venv_python, "requests", target_version)
