...
class EpdModel(BaseModel):
    def __init__(self, context):
        ...
        self.data = pd.DataFrame([
            {"Part Number": "EPD-001", "Description": "Power module",
                "Rating (A)": 5, "AWG": 14, "Temp (°C)": 85},
            {"Part Number": "EPD-002", "Description": "Signal interface",
                "Rating (A)": 1, "AWG": 24, "Temp (°C)": 60},
            {"Part Number": "EPD-003", "Description": "Relay driver",
                "Rating (A)": 10, "AWG": 18, "Temp (°C)": 105},
            {"Part Number": "EPD-004", "Description": "Grounding plate",
                "Rating (A)": 0, "AWG": 10, "Temp (°C)": 150},
        ])
