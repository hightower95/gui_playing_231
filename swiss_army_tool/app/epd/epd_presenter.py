...
from app.epd.SearchEpd.presenter import SearchEpdPresenter
...
class EpdPresenter(BasePresenter):
    def __init__(self, context):
        ...
        self.view = EpdModuleView()
        super().__init__(context, self.view, self.model, title="Search EPD")

        # Sub-presenters
        self.search_presenter = SearchEpdPresenter(context, self.model)
        # self.identify_presenter = IdentifyBestMatchPresenter(
        #     context, self.model)
        # self.where_used_presenter = WhereUsedPresenter(context, self.model)
