...
class SearchPresenter(QObject):
    ...
    def register_context_provider(self, provider: ContextProvider):
        ...
        if provider not in self.context_providers:
            ...
            print(
                f"✓ Registered context provider: {provider.get_context_name()}")
            ...
            for provider in self.context_providers:
                ...
                try:
                    ...
                    for ctx in contexts:
                        ...
                        print(
                            f"  ✓ Added context from {ctx.context_owner} for term '{ctx.term}'")
                except Exception as e:
                    print(
                        f"  ⚠️  Error getting context from {provider.get_context_name()}: {e}")
    ...
    def on_search(self, search_term: str):
        ...
        for result in all_results:
            ...
            print(
                f"  • {result.document_name}: {result.get_formatted_data()}{ctx_info}")
