...
from app.document_scanner.CompareVersions.view import CompareVersionsView
from app.document_scanner.CompareVersions.config_dialog import ComparisonConfigDialog
from app.document_scanner.document_store import DocumentStore
