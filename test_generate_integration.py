...
def test_generate_files_with_utilities():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Create step
        step = GenerateFilesStep(installation_settings=settings, shared_state=shared_state)
        ...
        try:
            ...
            # Verify files exist
            expected_files = ['run_app.pyw', 'update_app.pyw', 'launch_config.ini']
            for filename in expected_files:
                ...
                if file_path.exists():
                    ...
                    if '{{' not in content:
                        ...
                        print(f"⚠️ {filename} still contains unprocessed templates")
                else:
            ...
            if utilities_dir.exists() and utilities_dir.is_dir():
                ...
                if version_manager.exists():
                    print(f"✅ utilities/version_manager.py exists ({version_manager.stat().st_size} bytes)")
                else:
