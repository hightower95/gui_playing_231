...
class ThemeManager:
    ...
    def apply_light_theme(app: QApplication):
        ...
        palette.setColor(QPalette.AlternateBase, QColor(240, 240, 240))   # Alternate row color
        ...
        # Button colors
        palette.setColor(QPalette.Button, QColor(240, 240, 240))          # Light button background
        palette.setColor(QPalette.ButtonText, QColor(0, 0, 0))            # Black button text
        
        # Highlight colors
        palette.setColor(QPalette.Highlight, QColor(0, 120, 212))         # Blue highlight
    ...
    def apply_dark_theme(app: QApplication):
        ...
        # Base colors (input fields)
        palette.setColor(QPalette.Base, QColor(25, 25, 25))               # Dark input background
        palette.setColor(QPalette.AlternateBase, QColor(66, 66, 66))      # Alternate row color
        ...
        # Button colors
        palette.setColor(QPalette.Button, QColor(53, 53, 53))             # Dark button background
