...
class SourceSelector(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.upload_btn.clicked.connect(lambda: self._on_source_selected('upload'))
        ...
        self.server_btn.clicked.connect(lambda: self._on_source_selected('server'))
        ...
        self.cache_btn.clicked.connect(lambda: self._on_source_selected('cache'))
