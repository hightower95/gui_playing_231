...
@data_provider(
    ...
    requires=[
        ...
        param('sheet_name', str, default='Sheet1', description='Sheet name to load')
    ],
...
@reporter(
    ...
    parameters=[
        ...
        param('merge_type', str, default='concat', description='Merge type: concat or join'),
        param('join_key', str, default=None, description='Column to join on (if merge_type=join)')
    ],
...
def merge_excel_files(df1: pd.DataFrame, df2: pd.DataFrame, 
    ...
    if merge_type == 'concat':
        ...
        raise ValueError(f"Invalid merge_type '{merge_type}' or missing join_key")
